## control_toolbox (humble) - 3.7.1-1

The packages in the `control_toolbox` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble control_toolbox -y` on `Wed, 12 Aug 2026 16:21:47 -0000`
...
## control_toolbox (jazzy) - 4.11.1-1

The packages in the `control_toolbox` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy control_toolbox -y` on `Wed, 12 Aug 2026 16:20:51 -0000`
...
## control_toolbox (kilted) - 5.10.1-1

The packages in the `control_toolbox` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted control_toolbox -y` on `Wed, 12 Aug 2026 16:19:31 -0000`
...
## control_toolbox (lyrical) - 6.4.0-1

The packages in the `control_toolbox` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release -r lyrical control_toolbox -y` on `Wed, 12 Aug 2026 16:17:37 -0000`
...
## control_toolbox (rolling) - 6.4.0-1

The packages in the `control_toolbox` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling control_toolbox -y` on `Wed, 12 Aug 2026 16:16:27 -0000`
...
## control_toolbox (rolling) - 6.3.0-1

The packages in the `control_toolbox` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling control_toolbox -y` on `Fri, 17 Apr 2026 18:36:49 -0000`
...
## control_toolbox (kilted) - 5.10.0-1

The packages in the `control_toolbox` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted control_toolbox -y` on `Fri, 17 Apr 2026 18:32:10 -0000`
...
## control_toolbox (jazzy) - 4.11.0-1

The packages in the `control_toolbox` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy control_toolbox -y` on `Fri, 17 Apr 2026 18:26:58 -0000`
...
## control_toolbox (humble) - 3.7.0-1

The packages in the `control_toolbox` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble control_toolbox` on `Thu, 02 Apr 2026 12:29:32 -0000`
...
## control_toolbox (jazzy) - 4.10.0-1

The packages in the `control_toolbox` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy control_toolbox` on `Thu, 02 Apr 2026 12:27:07 -0000`
...
## control_toolbox (kilted) - 5.9.1-1

The packages in the `control_toolbox` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted control_toolbox` on `Thu, 02 Apr 2026 12:24:36 -0000`
...
## control_toolbox (rolling) - 6.2.0-1

The packages in the `control_toolbox` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling control_toolbox` on `Thu, 02 Apr 2026 12:18:12 -0000`
...
## control_toolbox (rolling) - 6.1.0-1

The packages in the `control_toolbox` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling control_toolbox` on `Mon, 01 Dec 2025 11:57:38 -0000`
...
## control_toolbox (kilted) - 5.8.3-1

The packages in the `control_toolbox` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --ros-distro kilted control_toolbox` on `Mon, 01 Dec 2025 11:55:23 -0000`
...
## control_toolbox (humble) - 3.6.3-1

The packages in the `control_toolbox` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble control_toolbox` on `Mon, 01 Dec 2025 11:52:21 -0000`
...
## control_toolbox (jazzy) - 4.9.0-1

The packages in the `control_toolbox` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy control_toolbox` on `Thu, 16 Oct 2025 21:10:38 -0000`
...
## control_toolbox (kilted) - 5.8.2-1

The packages in the `control_toolbox` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted -e control_toolbox` on `Thu, 16 Oct 2025 21:04:45 -0000`
...
## control_toolbox (rolling) - 6.0.0-1

The packages in the `control_toolbox` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling control_toolbox` on `Thu, 16 Oct 2025 17:49:46 -0000`
...
## control_toolbox (rolling) - 5.9.0-1

The packages in the `control_toolbox` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling -e control_toolbox` on `Thu, 16 Oct 2025 17:39:32 -0000`
...
## control_toolbox (jazzy) - 4.8.1-1

The packages in the `control_toolbox` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy control_toolbox` on `Sun, 05 Oct 2025 16:28:40 -0000`
...
## control_toolbox (kilted) - 5.8.1-1

The packages in the `control_toolbox` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted control_toolbox` on `Sun, 05 Oct 2025 16:27:16 -0000`
...
## control_toolbox (rolling) - 5.8.1-1

The packages in the `control_toolbox` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling control_toolbox` on `Sun, 05 Oct 2025 16:25:51 -0000`
...
## control_toolbox (jazzy) - 4.8.0-1

The packages in the `control_toolbox` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy control_toolbox` on `Thu, 02 Oct 2025 08:44:38 -0000`
...
## control_toolbox (kilted) - 5.8.0-1

The packages in the `control_toolbox` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted control_toolbox` on `Thu, 02 Oct 2025 08:34:54 -0000`
...
## control_toolbox (rolling) - 5.8.0-2

The packages in the `control_toolbox` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling control_toolbox` on `Thu, 02 Oct 2025 08:33:34 -0000`
...
## control_toolbox (rolling) - 5.8.0-1

The packages in the `control_toolbox` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling control_toolbox` on `Thu, 02 Oct 2025 08:31:39 -0000`
...
## control_toolbox (humble) - 3.6.2-1

The packages in the `control_toolbox` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble control_toolbox` on `Mon, 22 Sep 2025 20:41:38 -0000`
...
The packages in the `control_toolbox` repository were released into the `jazzy` distro by running `/home/bmagyar/.local/bin/bloom-release --rosdistro jazzy control_toolbox` on `Thu, 24 Apr 2025 11:16:37 -0000`
...
## control_toolbox (rolling) - 5.1.0-1
